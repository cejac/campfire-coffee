...
//   poundsTotal: 0,
//
//   custCalc: function(min, max) {
//     for (var i = 0; i < hours.length; i++) {
//       var perHourCust = Math.floor(Math.random() * (this.maxCust - this.minCust + 1)) + this.minCust;
//       this.custHourly.push(perHourCust);
//       this.totalCustHourly += perHourCust[i];
//     }
// },
//
//   cupsSold: function() {
//     for (var i = 0; i < hours.length; i ++) {
//       var cupsPerHour = (this.custHourly[i] * this.cups).toFixed(1);
//       this.cupsHourly.push(cupsPerHour);
//       this.cupsTotal += Math.ceil(cupsPerHour[i]);
//     }
//   },
//
//   poundsSold: function() {
//     for (var i = 0; i < hours.length; i++) {
//       var poundsHour = (this.custHourly[i] * this.toGo).toFixed(1);
//       this.poundsHourly.push(poundsHour);
//       this.poundsTotal += Math.ceil(poundsHour[i]);
//     }
//   }
//
//
